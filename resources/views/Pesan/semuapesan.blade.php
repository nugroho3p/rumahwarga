                               ...
                               <div class="box box-solid">
                                   ...
                                   <div class="box-body no-padding flat">
                                       <ul class="nav nav-pills nav-stacked">
                                           <li class="active"><a href="{{url('pesan')}}" style="font: 10px" ><i class="fa fa-inbox"></i> Pesan </a></li>
                                          <!--<li><a href="{{url('pesanTerkirim')}}"><i class="fa fa-envelope-o"></i> Pesan Terkirim </a></li>-->
                                       </ul>
                                   </div>
                               </div>
                           </div>
                               ...
                               <div class="table-responsive mailbox-messages">
                                   <table class="table table-hover table-striped">
                                       ...
                                       @foreach($join as $row)
                                           <tr>
                                                <td>
                                                    @if (Auth::user()->name == $row->pengirim)
                                                        {{$row->penerima}}
                                                    @else
                                                        {{$row->pengirim}}
                                                    @endif
                                               ...
                                               <td>
                                                   ...
                                                   <div class="btn-group">
                                                       ...
                                                       <button type="button" title="baca" class="btn flat btn-danger " data-toggle="modal" data-target="#baca{{$row->id_pesan}}" style="margin: 5px 2px; width: 100%;" onclick="getPesan()"><i class="fa fa-eye"></i>
                                                       </button>
                                                       </a>
                                                   </div>
                                                   @else
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{url("pesan/submit")}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group required">
                            ...
                            <div class="col-md-6">
                                ...
                                *.doc, .docx, .jpg, .jpeg, .png, .rar, .zip, .pdf
                            </div>
                            <div class="col-md-2"><span id="validateMsgIsi"></span></div>
                        </div>
