                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{url("lapor/submit")}}">
                        ...
                        <div class="disabled">
                            <div class="form-group">
                                <label class="hidden">Id Laporan</label>
                                <div class="col-md-6">
                                    <input type="hidden" readonly class="form-control" name="id_lapor">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <select name="jenis_lapor" class="form-control" required="true" oninput="validateJenisTagihan(this)">
                                        <option>Lapor Peta</option>
                                        <option>Lapor Barang</option>
                                        <option>Lapor Penjual</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control" rows="10" placeholder="Isi Laporan ..." name="isi"></textarea>
                            </div>
                        </div>
